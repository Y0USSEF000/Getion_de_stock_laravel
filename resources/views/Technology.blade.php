...
<head>
    ...
    <title>Technologie - ShopMaster</title>
...
<header class="custom-header">
    ...
    <nav class="nav-links">
        ...
        <a href="{{ route('page1') }}"><i class="fas fa-microchip"></i> Dernière page</a>
    </nav>
</header>

<section class="tech-container">
    <h2 class="section-title">Produits Technologiques</h2>

    @if($technologies->isEmpty())
        <p class="empty-message">Aucun produit technologique trouvé.</p>
    @else
        <div class="tech-grid">
            @foreach($technologies as $tech)
                <div class="tech-card">
                    @if($tech->image)
                        <img src="{{ asset('storage/' . $tech->image) }}" alt="{{ $tech->name }}" class="tech-img">
                    @endif
                    <h3 class="tech-title">{{ $tech->name }}</h3>
                    <p class="tech-detail"><i class="fas fa-tag"></i> Prix : {{ $tech->price }} MAD</p>
                    <p class="tech-detail"><i class="fas fa-box-open"></i> Quantité : {{ $tech->quantity }}</p>
                    <p class="tech-detail"><i class="fas fa-envelope"></i> Email : {{ $tech->email }}</p>
                    <p class="tech-detail"><i class="fas fa-phone"></i> Téléphone : {{ $tech->phone }}</p>
